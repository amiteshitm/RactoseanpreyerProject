...
export const InboxHtml = ({ parent }) => {
  return (
    <main className="px-2 flex-fill" style={{zIndex:0, marginTop:78}}>
      <div className="row">
        <div className="col-12 px-4 d-flex flex-column">
          <div className="row">
            <div className="col-lg-2 col-md-4 py-3 position-fixed" style={{marginLeft:30, marginTop:6}}>
            ...
            <div className="col-md py-3 tab-content" style={{marginLeft:320}}>
